export const translations = {
  pt: {
    ...
    hero: {
      ...
      cardDays: "Seg. (13h) a Sáb.",
      cardLunch: "13:00 – 14:00",
      cardLunchLabel: "Pausa (Ter.–Sáb.)",
    ...
    stats: {
      ...
      hoursDesc: "Horário alargado para o seu conforto",
      ozoneTitle: "Vapor de Ozónio",
      ozoneDesc: "Barbaterapia com ação purificante",
      precisionTitle: "Precisão & Fade",
      precisionDesc: "Cortes modernos e clássicos de topo",
      locationTitle: "Centro do Paião",
      locationDesc: "Rua da Direita 75, Figueira da Foz"
    },
    services: {
      badge: "Menu de Cuidados",
      title: "Serviços & Preços Oficiais",
      subtitle: "Qualidade de topo sem complicações. Escolha o serviço ideal para o seu estilo.",
      allCategories: "Todos",
      cuts: "Cortes",
      beards: "Barba & Rituais",
      combos: "Combos & Tratamentos",
      duration: "Duração",
    ...
    gallery: {
      ...
      title: "Trabalhos de Alta Precisão",
      subtitle: "Confira alguns dos nossos cortes, barbas alinhadas e a atmosfera da nossa barbearia.",
      all: "Todos",
      fade: "Degradê / Fade",
      barba: "Barba & Rituais",
      space: "Ambiente"
    ...
    location: {
      badge: "Onde Estamos",
      title: "Visite a Rota Do Corte no Paião",
      subtitle: "Fácil acesso no centro da vila com estacionamento nas imediações.",
      addressLabel: "Morada:",
      phoneLabel: "Telefone:",
      hoursLabel: "Horário de Funcionamento:",
      getDirections: "Abrir Rota no Google Maps",
    ...
    bookingModal: {
      ...
      step2Subtitle: "Marcação com 1 mês de adiantamento: Seg. (13h–22h), Ter.–Sex. (10h–22h), Sáb. (10h–18h).",
    ...
    cookies: {
      ...
      desc: "Utilizamos cookies essenciais para garantir uma navegação fluida e rápida.",
  ...
  en: {
    ...
    hero: {
      ...
      cardHours: "10:00 – 22:00",
      cardDays: "Mon. (13h) to Sat.",
      cardLunch: "13:00 – 14:00",
      cardLunchLabel: "Lunch (Tue.–Sat.)",
    ...
    stats: {
      ...
      precisionDesc: "Top-tier classic and modern haircuts",
      locationTitle: "Central Paião",
      locationDesc: "Rua da Direita 75, Figueira da Foz"
    },
    services: {
      badge: "Grooming Menu",
  ...
  es: {
    ...
    hero: {
      ...
      cardHours: "10:00 – 22:00",
      cardDays: "Lun. (13h) a Sáb.",
      cardLunch: "13:00 – 14:00",
      cardLunchLabel: "Pausa (Mar.–Sáb.)",
    ...
    stats: {
      ...
      hoursDesc: "Horario nocturno para tu comodidad",
      ozoneTitle: "Vapor de Ozono",
      ozoneDesc: "Barbaterapia purificante y relajante",
      precisionTitle: "Degradado y Tijera",
      precisionDesc: "Cortes de cabello de máximo nivel",
      locationTitle: "Centro de Paião",
      locationDesc: "Rua da Direita 75, Figueira da Foz"
    },
    services: {
      badge: "Carta de Servicios",
      title: "Servicios y Tarifas Oficiales",
      subtitle: "Máxima calidad a precios transparentes. Elige tu tratamiento ideal.",
      allCategories: "Todos",
      cuts: "Cortes",
      beards: "Barba y Rituais",
      combos: "Combos VIP",
      duration: "Duración",
    ...
    gallery: {
      ...
      subtitle: "Echa un vistazo a nuestros cortes degradados, barbas y el ambiente de la barbería.",
      all: "Todos",
      fade: "Degradados",
      barba: "Barba",
      space: "Espacio"
    ...
    location: {
      badge: "Dónde Estamos",
      title: "Visita Rota Do Corte en Paião",
      subtitle: "Ubicación céntrica con fácil aparcamiento en las inmediaciones.",
      addressLabel: "Dirección:",
      phoneLabel: "Teléfono:",
      hoursLabel: "Horario:",
      getDirections: "Ver Ruta en Google Maps",
    ...
    cookies: {
      ...
      desc: "Usamos cookies esenciales para ofrecerte una navegación fluida.",
      accept: "Aceptar Todo",
  ...
  fr: {
    ...
    hero: {
      ...
      cardHours: "10:00 – 22:00",
      cardDays: "Lun. (13h) au Sam.",
      cardLunch: "13:00 – 14:00",
      cardLunchLabel: "Pause (Mar.–Sam.)",
    ...
    stats: {
      ...
      hoursDesc: "Horaires étendus pour votre confort",
      ozoneTitle: "Vapeur d'Ozone",
      ozoneDesc: "Soin purifiant et apaisant de la barbe",
      precisionTitle: "Précision & Dégradé",
      precisionDesc: "Coupes modernes et classiques",
      locationTitle: "Centre de Paião",
      locationDesc: "Rua da Direita 75, Figueira da Foz"
    },
    services: {
      badge: "Carte des Soins",
      title: "Services & Tarifs Officiels",
      subtitle: "Artisanat d'exception à prix transparents. Choisissez votre soin idéal.",
      allCategories: "Tous",
      cuts: "Coupes",
      beards: "Barbe & Rituels",
      combos: "Combos VIP",
      duration: "Durée",
    ...
    gallery: {
      ...
      subtitle: "Découvrez nos dégradés, barbes sculptées et l'ambiance de notre salon.",
      all: "Tous",
      fade: "Dégradés",
      barba: "Barbe",
      space: "Ambiance"
    ...
    location: {
      badge: "Nous Trouver",
      title: "Visitez Rota Do Corte à Paião",
      subtitle: "Accès facile au centre-ville avec stationnement à proximité.",
    ...
    cookies: {
      ...
      desc: "Nous utilisons des cookies essentiels pour garantir une navigation rapide et fluide.",
