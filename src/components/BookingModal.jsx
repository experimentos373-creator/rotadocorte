...
function ServiceAvatar({ serviceId, isSelected, isDark }) {
  if (serviceId === "barba-terapia") {
    return (
      <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center shrink-0 border transition-colors ${
        isSelected
...
export default function BookingModal({ isOpen, onClose, preselectedService }) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-5 overflow-y-auto overscroll-contain animate-fadeIn"
      onClick={onClose}
    >
      <div
        className={`relative w-full max-w-lg sm:max-w-xl max-h-[92vh] flex flex-col rounded-[24px] sm:rounded-[28px] p-4 sm:p-6 shadow-2xl my-auto text-left border transition-all overflow-hidden ${
          isDark
      ...
      >
        ...
        <div className="mb-3 space-y-2 shrink-0">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full border border-[#C89B58]/30 flex items-center justify-center text-[#C89B58]">
                <Scissors className="w-3.5 h-3.5 -rotate-45" />
              </div>
              <div className="flex flex-col">
                <span className={`text-[11px] sm:text-xs font-bold tracking-widest uppercase leading-tight ${
                  isDark ? "text-white" : "text-[#18181B]"
                }`}>
                  Rota Do Corte
                </span>
                <span className="text-[8px] font-bold tracking-widest uppercase text-[#C89B58]">
                  • Paião
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              {step < 5 && (
                <span className={`text-[9px] sm:text-[10px] font-bold uppercase tracking-wider px-2.5 py-0.5 sm:py-1 rounded-full border ${
                  isDark
        ...
        {/* ========================================================================= */}
        {step === 1 && (
          <div className="flex-1 flex flex-col min-h-0 overflow-y-auto space-y-3 animate-fadeIn pr-0.5">
            ...
            {/* Service Cards (5 cards tightly packed with cohesive spacing) */}
              ...
              {servicesData.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-2.5 sm:p-3 rounded-2xl text-left border transition-all relative overflow-hidden group cursor-pointer flex items-center justify-between gap-2.5 ${
                      isSelected
                        ? isDark
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {s.badge && (
                            <span className={`text-[7.5px] sm:text-[8px] uppercase tracking-wider px-1.5 py-0.2 rounded-full font-bold border ${
                              isDark
                        ...
                        <div className="flex items-center gap-1 text-[10px] text-[#C89B58] font-medium pt-0.5">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      {isSelected && (
                        <div className="w-4 h-4 rounded-full bg-[#C89B58] text-white flex items-center justify-center shadow-xs">
            ...
            {/* Step 1 Footer */}
            <div className="mt-auto pt-2.5 flex items-center justify-between gap-3 border-t border-black/5 dark:border-white/5 shrink-0">
              ...
              <button
                type="button"
                onClick={() => setStep(2)}
                className="w-full sm:w-auto ml-auto bg-[#18181B] hover:bg-black text-white px-6 py-2.5 sm:px-7 sm:py-3 rounded-full text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
        ...
        {/* ========================================================================= */}
        {step === 2 && (
          <div className="flex-1 flex flex-col min-h-0 overflow-y-auto space-y-3 animate-fadeIn">
            <div className="shrink-0">
              <h2 className={`text-lg sm:text-xl font-bold tracking-tight ${
                isDark ? "text-white" : "text-[#18181B]"
              }`}>
              ...
              {getNextDays().map((d) => {
                ...
                return (
                  <button
                    ...
                    className={`py-1.5 sm:py-2 px-0.5 rounded-xl text-center border transition-all flex flex-col items-center justify-center cursor-pointer min-h-[42px] sm:min-h-[48px] ${
                      d.isSunday
                        ? isDark
                  ...
                  >
                    <span className={`text-[7.5px] sm:text-[8px] uppercase tracking-wider font-bold leading-none ${
            ...
            {/* Step 2 Footer */}
            <div className="mt-auto pt-2.5 flex items-center justify-between border-t border-black/5 dark:border-white/5 shrink-0">
              <button
                type="button"
                onClick={() => setStep(1)}
              ...
              <button
                type="button"
                onClick={() => setStep(3)}
                className="bg-[#18181B] hover:bg-black text-white px-6 py-2.5 sm:px-7 sm:py-3 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
        ...
        {step === 3 && (
          <div className="flex-1 flex flex-col min-h-0 overflow-y-auto space-y-3 animate-fadeIn">
            <div className="shrink-0">
              ...
              <p className={`text-xs mt-0.5 leading-tight capitalize ${
                isDark ? "text-[#9E9EA7]" : "text-[#71717A]"
              }`}>
                        ...
                        .map((slot) => {
                          ...
                          return (
                            <button
                              ...
                              className={`py-2.5 px-2 rounded-xl text-xs font-bold border transition-all flex flex-col items-center justify-center min-h-[42px] ${
                                isOccupied
                                  ? isDark
            ...
            {selectedTime && (
              <div className={`p-2.5 rounded-xl border flex items-center justify-between text-xs shrink-0 animate-fadeIn ${
                isDark
            ...
            <div className="mt-auto pt-2.5 flex items-center justify-between border-t border-black/5 dark:border-white/5 shrink-0">
              ...
              <button
                ...
                onClick={() => setStep(4)}
                className="bg-[#18181B] hover:bg-black disabled:opacity-40 text-white px-6 py-2.5 sm:px-7 sm:py-3 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
        ...
        {/* ========================================================================= */}
        {step === 4 && (
          <form onSubmit={handleBookingSubmit} className="flex-1 flex flex-col min-h-0 overflow-y-auto space-y-3 animate-fadeIn">
            <div className="shrink-0">
              <h2 className={`text-lg sm:text-xl font-bold tracking-tight ${
                isDark ? "text-white" : "text-[#18181B]"
              }`}>
            ...
            {/* Clean Summary Card */}
            <div className={`p-3 rounded-2xl border flex items-center justify-between text-xs shrink-0 ${
              isDark
            ...
            <div className="space-y-2.5 py-0.5">
              ...
              <div className="space-y-0.5">
                ...
                <input
                  ...
                  className={`w-full px-3.5 py-2 sm:py-2.5 text-xs rounded-xl border focus:outline-none transition-colors ${
                    isDark
            ...
            <div className="mt-auto pt-2.5 flex items-center justify-between border-t border-black/5 dark:border-white/5 shrink-0">
              ...
              <button
                ...
                className="bg-[#18181B] hover:bg-black disabled:opacity-50 text-white px-6 py-2.5 sm:px-7 sm:py-3 rounded-full text-xs font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
                {isSubmitting ? (
                  <>
        ...
        {/* ========================================================================= */}
        {step === 5 && (
          <div className="flex-1 flex flex-col min-h-0 overflow-y-auto space-y-3.5 text-center py-1 animate-fadeIn">
            <div className="w-12 h-12 rounded-full bg-[#C89B58]/20 border-2 border-[#C89B58] flex items-center justify-center text-[#E5C268] mx-auto shadow-md shadow-[#C89B58]/20 shrink-0">
            ...
            <div className={`p-3.5 rounded-2xl border text-left space-y-2 text-xs shrink-0 ${
            ...
            <div className="space-y-2 pt-0.5 shrink-0">
              ...
              <a
                ...
                className="w-full py-3 text-xs uppercase tracking-wider font-bold rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white flex items-center justify-center gap-2 transition-all shadow-md shadow-[#25D366]/20 cursor-pointer"
              >
