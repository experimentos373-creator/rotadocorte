...
export default function BookingModal({ isOpen, onClose, preselectedService }) {
  ...
  return (
    ...
    >
      <div
        className={`relative w-[95vw] sm:w-full max-w-xl sm:max-w-2xl h-[90vh] sm:h-auto sm:max-h-[92vh] flex flex-col rounded-[24px] sm:rounded-[28px] p-4 sm:p-6 shadow-2xl my-auto text-left border transition-all overflow-hidden ${
          isDark
      ...
      >
        ...
        {/* ========================================================================= */}
        <div className="mb-3 sm:mb-4 space-y-2.5 shrink-0">
          <div className="flex items-center justify-between gap-3">
            {/* Left: Scissors Brand Mark */}
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-[#C89B58]/30 flex items-center justify-center text-[#C89B58]">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] sm:text-[8.5px] font-bold tracking-widest uppercase text-[#C89B58]">
                  • Paião
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              {step < 5 && (
                <span className={`text-[9px] sm:text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full border ${
                  isDark
        ...
        {/* ========================================================================= */}
        {/* PASSO 1: ESCOLHA O SERVIÇO (OCCUPIES 90% SCREEN HARMONIOUSLY)             */}
        {/* ========================================================================= */}
        {step === 1 && (
          <div className="flex-1 flex flex-col justify-between min-h-0 overflow-y-auto space-y-2.5 sm:space-y-3 animate-fadeIn pr-0.5">
            ...
            {/* Service Cards (5 cards filling the vertical space nicely) */}
            <div className="flex-1 flex flex-col justify-between gap-2 sm:gap-2.5 py-1 min-h-0">
              {servicesData.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-2.5 sm:p-3.5 rounded-2xl text-left border transition-all relative overflow-hidden group cursor-pointer flex items-center justify-between gap-3 ${
                      isSelected
                        ? isDark
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                          ...
                          {s.badge && (
                            <span className={`text-[7.5px] sm:text-[8.5px] uppercase tracking-wider px-2 py-0.5 rounded-full font-bold border ${
                              isDark
                        ...
                        <p className={`text-[11px] sm:text-xs leading-tight truncate mt-0.5 ${
                          isDark ? "text-[#9E9EA7]" : "text-[#71717A]"
                        }`}>
                          {s.shortDesc}
                        </p>
                        <div className="flex items-center gap-1 text-[10.5px] sm:text-[11px] text-[#C89B58] font-medium pt-0.5">
                    ...
                    <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
                      ...
                      {isSelected && (
                        <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-[#C89B58] text-white flex items-center justify-center shadow-xs">
            ...
            {/* Step 1 Footer */}
            <div className="pt-2.5 flex items-center justify-between gap-3 border-t border-black/5 dark:border-white/5 shrink-0">
              <div className="hidden sm:flex items-center gap-1.5 text-xs text-[#71717A] dark:text-[#9E9EA7]">
                ...
                <span className="text-[11px]">Ambiente seguro e profissional</span>
              </div>
              <button
                type="button"
                onClick={() => setStep(2)}
                className="w-full sm:w-auto ml-auto bg-[#18181B] hover:bg-black text-white px-7 py-3 sm:px-8 sm:py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
        ...
        {/* ========================================================================= */}
        {step === 2 && (
          <div className="flex-1 flex flex-col justify-between min-h-0 overflow-y-auto space-y-3 animate-fadeIn">
            <div className="shrink-0">
              <h2 className={`text-lg sm:text-2xl font-bold tracking-tight ${
                isDark ? "text-white" : "text-[#18181B]"
              }`}>
            ...
            <div className="pt-3 flex items-center justify-between border-t border-black/5 dark:border-white/5 shrink-0">
              ...
              <button
                type="button"
                onClick={() => setStep(3)}
                className="bg-[#18181B] hover:bg-black text-white px-7 py-3 sm:px-8 sm:py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
        ...
        {step === 3 && (
          <div className="flex-1 flex flex-col justify-between min-h-0 overflow-y-auto space-y-3 animate-fadeIn">
            <div className="shrink-0">
              ...
              <p className={`text-xs sm:text-sm mt-0.5 leading-relaxed capitalize ${
                isDark ? "text-[#9E9EA7]" : "text-[#71717A]"
              }`}>
            ...
            {isLoadingSlots ? (
              ...
              <div className={`py-8 text-center space-y-3 p-6 rounded-2xl border flex-1 flex flex-col items-center justify-center ${
                ...
                <p className={`text-xs sm:text-sm max-w-sm mx-auto ${isDark ? "text-[#9E9EA7]" : "text-[#71717A]"}`}>
                        ...
                        .map((slot) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {isOccupied && (
                                <span className="text-[8px] font-bold text-red-500 uppercase tracking-tight mt-0.5">
                                  OCUPADO
                                </span>
                              )}
                            </button>
            ...
            <div className="pt-3 flex items-center justify-between border-t border-black/5 dark:border-white/5 shrink-0">
              ...
              <button
                ...
                onClick={() => setStep(4)}
                className="bg-[#18181B] hover:bg-black disabled:opacity-40 text-white px-7 py-3 sm:px-8 sm:py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
        ...
        {step === 4 && (
          <form onSubmit={handleBookingSubmit} className="flex-1 flex flex-col justify-between min-h-0 overflow-y-auto space-y-3.5 animate-fadeIn">
            ...
            {errorMessage && (
              <div className={`p-3 rounded-xl border text-xs flex items-center gap-2.5 shrink-0 ${
                isDark
            ...
            <div className="pt-3 flex items-center justify-between border-t border-black/5 dark:border-white/5 shrink-0">
              ...
              <button
                ...
                className="bg-[#18181B] hover:bg-black disabled:opacity-50 text-white px-7 py-3 sm:px-8 sm:py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider flex items-center gap-2 cursor-pointer transition-all shadow-md hover:scale-[1.01]"
              >
                {isSubmitting ? (
                  <>
