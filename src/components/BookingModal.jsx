      ...
      >
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[9px] sm:text-[10px] font-medium text-[#C89B58] leading-tight">
                  Paião
                </span>
              </div>
            </div>
        ...
        {step === 1 && (
          <div className="flex-1 min-h-0 flex flex-col justify-between pt-1 animate-fadeIn">
            ...
            {/* Zero-Scroll Compact Grid: All 5 services fit 100% cleanly without vertical scroll */}
                ...
                return (
                  <div
                    ...
                    className={`relative p-2.5 sm:p-3 rounded-xl sm:rounded-2xl border transition-all cursor-pointer flex flex-col justify-between group ${
                      ...
                      isSelected
                        ? isDark
                          ? "bg-[#131620] border-[#C89B58] ring-1 ring-[#C89B58] shadow-md shadow-[#C89B58]/10"
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {isSelected && (
                        <div className="w-4 h-4 rounded-full bg-[#C89B58] text-black flex items-center justify-center shrink-0 shadow-xs">
                    ...
                    <div className="flex items-center justify-between pt-1.5 mt-1 border-t border-white/5 dark:border-white/5">
                      <div className="flex items-center gap-1 text-[11px] text-[#C89B58] font-medium">
            ...
            {/* Step 1 Footer */}
            <div className="pt-2.5 sm:pt-3 mt-1.5 flex items-center justify-between gap-3 border-t border-white/10 dark:border-white/10 shrink-0 z-20">
              <div className="hidden sm:flex items-center gap-2 text-xs text-[#71717A] dark:text-[#9E9EA7] shrink-0">
                <ShieldCheck className="w-3.5 h-3.5 text-[#C89B58] shrink-0" />
              ...
              <button
                ...
                className={`w-full sm:w-auto ml-auto px-6 sm:px-8 py-2.5 sm:py-3 rounded-full text-xs font-bold tracking-wide flex items-center justify-center gap-2 transition-all shadow-lg shrink-0 whitespace-nowrap ${
                  selectedServiceId
          ...
          <div className="flex-1 min-h-0 flex flex-col justify-between pt-1 animate-fadeIn">
                      ...
                      d.isSunday
                        ...
                        : isSelected
                          ...
                          : isDark
                            ...
                            : "bg-white border-[#E8E4DC] text-[#18181B] hover:border-[#C89B58] hover:bg-[#FAF6F0] shadow-xs"
                    }`}
                  >
            ...
            <div className="pt-2.5 sm:pt-3 mt-1.5 flex items-center justify-between gap-3 border-t border-white/10 dark:border-white/10 shrink-0 z-20">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="text-xs sm:text-sm font-semibold flex items-center gap-1.5 text-[#71717A] hover:text-black dark:text-[#9E9EA7] dark:hover:text-white cursor-pointer transition-colors shrink-0 whitespace-nowrap"
              >
              ...
              <button
                type="button"
                onClick={() => setStep(3)}
                className="bg-[#C89B58] hover:bg-[#d8ab66] text-black font-extrabold px-6 sm:px-8 py-2.5 sm:py-3 rounded-full text-xs tracking-wide flex items-center gap-2 cursor-pointer transition-all shadow-lg shadow-[#C89B58]/20 hover:scale-[1.02] shrink-0 whitespace-nowrap"
              >
          ...
          <div className="flex-1 min-h-0 flex flex-col justify-between pt-1 animate-fadeIn">
            ...
            {isLoadingSlots ? (
              ...
              <div className={`py-8 text-center space-y-3 p-6 rounded-2xl border my-auto ${
                ...
                <button
                  type="button"
                  onClick={() => setStep(2)}
                  className="bg-[#C89B58] text-black font-bold px-6 py-2.5 text-xs rounded-full cursor-pointer hover:bg-[#d8ab66]"
                >
                  Escolher Outra Data
                </button>
              </div>
                                ...
                                isOccupied
                                  ...
                                  : isSelected
                                    ...
                                    : isDark
                                      ...
                                      : "bg-white border-[#E8E4DC] text-[#18181B] hover:border-[#C89B58] hover:bg-[#FAF6F0] shadow-xs cursor-pointer"
                              }`}
                            >
            ...
            {selectedTime && (
              <div className={`p-2.5 sm:p-3 rounded-xl border flex items-center justify-between text-xs sm:text-sm shrink-0 my-1.5 animate-fadeIn ${
                ...
                <span className="text-[11px] font-semibold text-[#C89B58]">Selecionado</span>
              </div>
            )}
            ...
            <div className="pt-2.5 sm:pt-3 mt-1.5 flex items-center justify-between gap-3 border-t border-white/10 dark:border-white/10 shrink-0 z-20">
              ...
              <button
                ...
                onClick={() => setStep(4)}
                className="bg-[#C89B58] hover:bg-[#d8ab66] disabled:opacity-40 text-black font-extrabold px-6 sm:px-8 py-2.5 sm:py-3 rounded-full text-xs tracking-wide flex items-center gap-2 cursor-pointer transition-all shadow-lg shadow-[#C89B58]/20 hover:scale-[1.02] shrink-0 whitespace-nowrap"
              >
          ...
          <form onSubmit={handleBookingSubmit} className="flex-1 min-h-0 flex flex-col justify-between pt-1 animate-fadeIn">
            ...
            <div className={`p-3 sm:p-4 rounded-xl border flex items-center justify-between text-xs sm:text-sm shrink-0 mb-2.5 ${
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <Scissors className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C89B58]" />
                  <p className="font-bold text-xs sm:text-sm md:text-base">
                    {currentService.name}
                  </p>
                </div>
                <p className={`text-[11px] sm:text-xs capitalize font-medium ${isDark ? "text-[#E5C268]" : "text-[#8C601E]"}`}>
                  {formattedDatePortuguese} às <strong>{selectedTime}</strong>
                </p>
              </div>
              <div className="text-right">
                <span className="font-bold text-sm sm:text-lg font-mono text-[#C89B58]">
                  {currentService.priceFormatted}
                </span>
                <p className={`text-[11px] sm:text-xs ${isDark ? "text-[#9E9EA7]" : "text-[#71717A]"}`}>
            ...
            <div className="pt-2.5 sm:pt-3 mt-1.5 flex items-center justify-between gap-3 border-t border-white/10 dark:border-white/10 shrink-0 z-20">
              ...
              <button
                ...
                className="bg-[#C89B58] hover:bg-[#d8ab66] disabled:opacity-50 text-black font-extrabold px-6 sm:px-8 py-2.5 sm:py-3 rounded-full text-xs tracking-wide flex items-center gap-2 cursor-pointer transition-all shadow-lg shadow-[#C89B58]/20 hover:scale-[1.02] shrink-0 whitespace-nowrap"
              >
                {isSubmitting ? (
                  <>
        ...
        {step === 5 && (
          <div className="flex-1 min-h-0 flex flex-col justify-between items-center text-center py-2 sm:py-3 animate-fadeIn max-w-2xl mx-auto w-full">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#C89B58]/20 border-2 border-[#C89B58] flex items-center justify-center text-[#E5C268] mx-auto shadow-lg shadow-[#C89B58]/20 shrink-0 mb-1.5">
